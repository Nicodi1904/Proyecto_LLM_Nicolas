...
# GUARDAR EN UTF-8
with open(r"c:\Users\Owner\Documents\2025-2\Tesis-MAS-LLM\resultado_summary.json", 'w', encoding='utf-8') as f:
    json.dump(summary_recortado, f, indent=2, ensure_ascii=False)
